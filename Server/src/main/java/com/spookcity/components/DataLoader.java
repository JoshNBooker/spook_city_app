...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Ghost ghost2 = new Ghost(
                "Mackenzie Poltergeist", "mackenziePoltergeist.jpg","'Bloody Mackenzie', is the malevolent spirit of Sir George Mackenzie, a notorious persecutor of Covenanters. People have reported sudden drops in temperature, unexplained injuries, and even fainting spells when visiting his mausoleum."
                , LocalDate.of(1691, 2, 28), "Who dares summon me?!");
        Ghost ghost3 = new Ghost("Abandoned Annie", "abandonedAnnie.jpg","Visitors have reported sightings of a young girl named Annie who died in the close during the plague. Her spirit is said to wander the underground streets, and some have heard her laughter or seen her apparition.", LocalDate.of(1823, 6, 5), "Get out of my room!");
